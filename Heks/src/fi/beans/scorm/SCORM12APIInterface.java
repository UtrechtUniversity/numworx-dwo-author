 ...
 * defined in the SCORM Version 1.2 Run-Time Environment Book.<br>
 * <br>
 * 
 * <strong>Filename:</strong> SCORM1.2_API_Interface.java<br>
 * <br>
 * 
 ...
 * that are available for SCORM Version 1.2 Conformant SCOs.<br>
 * <br>
 * 
 ...
 * It is the responsibility of the implementation of this interface to perform
 * any and all LMS behaviors including but not limited to error code management
 * as defined in the SCORM Version 1.2.<br>
 * <br>
 * 
...
public interface SCORM12APIInterface {
	...
	/**
	 * own constante for the DWO. It indicates if the user is a student or a
	 * teacher.
	 */
	 ...
	 */
	public final static String UG_STUDENT = "UG_STUDENT";

	/**
	 * The user is a teacher.
	 */
	public final static String UG_TEACHER = "UG_TEACHER";

	/**
	 * The user is a guest.
	 */
	public final static String UG_GUEST = "UG_GUEST";
	 ...
	 * 
	 * @param iParam
	 *            "" An empty string must be passed for conformance to this
	 *            standard. Values other than "" are reserved for future
	 *            extensions.
	 * 
	 * @return String representing a boolean.
	 *         <ul>
	 *         <li>  <code>true</code> result indicates that the LMSInitialize("")
	 *         was successful</li>
	...
	/**
	 * The SCO must call this when it has determined that it no longer needs to
	 * communicate with the LMS, if it successfully called
	 ...
	 *         was unsuccessful</li>
	 *         </ul>
	 *         If a return value of <code>true</code> is returned, then the SCO
	 *         may no longer call any other API methods.If a return value of
	...
	/**
	 * This method allows the SCO to obtain information from the LMS. It is used
	 * to determine:
	 * <ul>
	 * <li>Values for various categories (groups) and elements in the data model
	 * </li>
	 ...
	 * </ul>
	 * The complete data element name and/or keywords are provided as a
	 * parameter. The current value of the requested data model parameter is
	 * returned. Only one value -- always a string -- is returned for each call.
	 * 
	 * @param iElement
	 *            <ul>
	 *            <li>datamodel.group.element Returns the value of the named
	 *            element</li>
	 *            <li>datamodel._version The _version keyword is used to
	 *            determine the version of the data model supported by the LMS.</li>
	 *            <li>datamodel.element._count The _count keyword is used to
	 *            determine the number of elements currently in an array. The
	 *            count is the total number of elements in the array, not the
	 *            index number of the last position in the array.</li>
	 *            <li>datamodel.element._children The _children keyword is used
	 *            to determine all of the elements in a group or category that
	 *            are supported by the LMS.</li>
	 *            </ul>
	 * @return All return values are strings.
	 *         <ul>
	 *         <li>LMSGetValue(datamodel.group.element) The return value is a
	 *         string representing the current value of the requested element or
	 *         group.</li>
	 ...
	 *         group or category that are supported by the LMS. If an element
	 *         has no children, but is supported, an empty string ("") is
	 *         returned. An empty string ("") is also returned if an element is
	 *         not supported. A subsequent request for last error
	 *         [LMSGetLastError()] can determine if the element is not
	 *         supported. The error "401 Not implemented error" indicates the
	 *         element is not supported.</li>
	 *         <li>LMSGetValue(datamodel.group._count) The return value is an
	 *         integer that indicates the number of items currently in an
	 *         element list or array.</li>
	 *         </ul>
	 */
	public String LMSGetValue(String iDataModelElement);

	/**
	 * This method allows the SCO to send information to the LMS. The API
	 * Adapter may be designed to immediately forward the information to the
	 * LMS, or it may be designed to forward information based on some other
	 * approach. This method is used to set the current values for various
	 * categories (groups) and elements in the data model. The data element name
	 * and its group are provided as a parameter. The newly desired value of the
	 * data element is included as the second parameter in the call. Only one
	 * value is sent with each call.
	 * 
	 * @param iElement
	 *            This is the name of a fully qualified element defined in the
	 *            data model. The argument is case sensitive. The argument is a
	 *            string enclosed in quotes. The following represents some forms
	 *            this parameter may take.
	 *            <ul>
	 *            <li>datamodel.element This is the name of a category or group
	 *            defined in the Data Model. An example is "cmi.comments".</li>
	 *            <li>datamodel.group.element This is the name of an element
	 *            defined in the Data Model. An example is
	 *            "cmi.core.lesson_status".datamodel.group.n.element The value
	 *            of the sub-element in the nth-1 member of the element array
	 ...
	 * Adapter may persist set values as soon as they are received, and not
	 * cache them on the client. In such implementations, this API call is
	 * redundant and would result in no additional action from the API Adapter.
	 ...
	 *            requests additional information on the listed error code.</li>
	 * 
	 *            <li>"". An empty string. This requests additional information
	 *            on the last error that occurred.</li>
	 *            </ul>
	 * 
