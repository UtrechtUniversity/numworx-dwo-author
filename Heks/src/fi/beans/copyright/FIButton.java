...
public class FIButton extends Component {
	...
	public void paint(Graphics g) { // logo
		...
		// button outline
		/*
		 * g.setColor(Color.white); g.drawLine(0, 0, getSize().width - 1, 0);
		 * g.drawLine(0, 0, 0, getSize().height - 1); g.setColor(Color.black);
		 * g.drawLine(getSize().width - 1, 0, getSize().width - 1,
		 * getSize().height - 1); g.drawLine(0, getSize().height - 1,
