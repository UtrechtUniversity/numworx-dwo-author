...
{   double length, width, height;
    ...
    public Box()
    {}
    public Box(double l, double w, double h, Color oc)
...
class Axes extends Object3D
{
    ...
    public Axes()
    {}
    public Axes(Color xColor, Color yColor, Color zColor)
    {
        numVertices = 4;
        vertices = new Vector3D[numVertices];
        // do NOT forget this
...
{   double height;
    ...
    public Piramid()
    {};
    public Piramid(double h, Color oc)
    {   height = h;
