...
{   // "empty" ellipsoid, use for copying
    ...
    public Ellipsoid(double bigC, double smallC1, double smallC2, Color oc)
    {   paramNum = 3;
        params = new double[3];
        params[0] = bigC;
        params[1] = smallC1;
...
{   boolean top, bottom;
    ...
    public Cylinder(double radius, double height, Color oc, boolean t, boolean b)
    {   top = t;
        bottom = b;
        paramNum = 2;
        params = new double[2];
...
{   boolean bottom;
    ...
    public Cone(double radius, double height, Color oc, boolean b)
    {   bottom = b;
        paramNum = 2;
        params = new double[2];
        params[0] = radius;
