...
// irreversable
    ...
    // painting
    public void paintObject3D(Graphics g, boolean shadow, boolean inside, 
...
// now find all OTHER labels present in the original object
        ...
        if ((start.modelCode == DoorzienFrame.CYLINDER) ||
            (start.modelCode == DoorzienFrame.CONE1) ||
            (start.modelCode == DoorzienFrame.CONE2) ||
            (start.modelCode == DoorzienFrame.CONE3) ||
            (start.modelCode == DoorzienFrame.CONE4)
            )
