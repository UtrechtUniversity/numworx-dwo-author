...
public class Text_nl extends java.util.ListResourceBundle {
	...
	{
		{	"inputAreasTitle", "Definitie invulgebieden"},
		{	"inputAreasButton", "Invulgebieden instellen"},
		...
		{	"formRecognitionCB", "Formules (met herkenning)"},
		{	"showWritingRB", "Toon geschreven formules"},
		{	"showFormFontRB", "Toon formules in fonts"},
		{	"inputOptionCB", "Gebruik voor invullen vakken"},
		{	"titleLayoutLabel", "Opmaak"},
		{	"gridCB", "Toon ruitjes"},
		{	"scaleWritingCB", "verklein schrijfwerk/tekeningen"},
		{	"scaleWritingLabel", "Vergrotingfactor"},
		
		 { "CBA_drawing", "tekening/formules"},
