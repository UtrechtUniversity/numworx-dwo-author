...
public class VarSet 
{
	...
	{	
		...
		levelDescriptions[0] = JavaLogoWeb3d.rb.getString("Tekenalgoritme");
	}
	...
	/**
	 * Substitueert waarden voor variabelen in een expressie.
	 * Is eigenlijk een monstertje. In plaats van de lijst af te lopen zou de expressie
	 * bij evaluatie gewoon via 'findVariable()' de var moeten zoeken en waarde opvragen...
	 * Nu moet de fix voor de scope ook hier worden toegepast.
	 * 
	 * @param e	Expressie met variabelen (namen)
	 * @return	Expressie met vars vervangen door values
	 */
