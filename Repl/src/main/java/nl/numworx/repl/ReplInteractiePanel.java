...
public class ReplInteractiePanel extends JPanel implements InteractiePanel, CBookAware {

	public ReplInteractiePanel() {
		setOpaque(true);
	...
	public void paint(Graphics g) {
		...
		g.drawString("REPL Interpreter", w/10, h/2);
	}
	...
	public InteractieEditPanel getEditPanel() {
		return new ReplInteractieEditPanel();
	}
