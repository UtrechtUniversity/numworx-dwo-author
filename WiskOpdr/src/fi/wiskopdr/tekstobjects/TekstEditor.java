...
//			}
    ...
    {   if(headerAan)
        ...
        {
        		tekstVak.setBounds(5,5,b-10-(toolbarLeft?33:0),h-50);
        }
        else
        {
        		tekstVak.setBounds(5,5,b-10-(toolbarLeft?33:0),tekstVak.getHeight());
        }
	...
	{	if(e.getSource()==formuleKnop)
		...
		{	tekstVakActief.insertTekstInteractiePanelVak(3,0);
