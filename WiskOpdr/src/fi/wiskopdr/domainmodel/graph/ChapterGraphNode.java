...
public class ChapterGraphNode {
	...
	private static HashMap<String, String> hfstDescriptionsMap = new HashMap<>();
	...
	public static void initChapterDescription(StudentMethod active) {
	  hfstDescriptionsMap.clear();
      ...
      for (int i = 0; i < bsize; i++) {
        ...
        for (int j = 0; j < csize; j++) {
          hfstDescriptionsMap.put(key + "-" + book + "-" + (j+1), chapters.get(j));
        }
...
//	}
    ...
    public static Collection<String> hfstCodes() {    
      return hfstDescriptionsMap.keySet();
    }
