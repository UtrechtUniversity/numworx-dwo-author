...
public class FilterAction extends AbstractAction {
    ...
    final Consumer<Map<String,Map<String,Collection<Number>>>> consumer;
    
    public FilterAction( Component owner, Consumer<Map<String,Map<String,Collection<Number>>>> consumer) {
      super("Filter");
      this.owner = owner;
...
//      genr.setTree(tree);
    ...
    Map<String, Map<String, Collection<Number>>> filter = Collections.emptyMap();
