...
{	
	...
	private static Font defaultFont = (!WiskOpdr.formTimes) || WiskOpdr.mac || WiskOpdr.zoefi ? WiskOpdr.formuleFont2Mac : WiskOpdr.formuleFont2; //new Font("TimesRoman",Font.PLAIN,14);
...
//		}
	...
	{
		actieveRegel.zetVectorNotatieVak();
		actieveRegel.deSelect();
		formuleVak.addState();
	}
	...
	{	String s = toString();
		...
		String ofLabel = WiskOpdr.rb.getString("ofLabel");
		int index = 0;
		int teller = 0;
		while (index !=-1)
