 ...
 * @author David Kloba
 */
public class MWArrowButton extends JButton implements SwingConstants
{
        ...
        public MWArrowButton(int direction, Color background, Color shadow,
        ...
        public MWArrowButton(int direction) {
