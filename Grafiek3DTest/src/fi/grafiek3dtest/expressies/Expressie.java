...
{	
	...
	{	dfs = new DecimalFormatSymbols();
		if(Grafiek3DTest.language.toString().equals("nl")) dfs.setDecimalSeparator(',');
		else dfs.setDecimalSeparator('.');
		if(Grafiek3DTest.language.toString().equals("nl")) dfs.setGroupingSeparator(' ');
...
/*	
	private static Expressie evalWithIdeas(String evalCommand)
	{
		...
		if(expr != null)
			return expr;
		RuleIF result = Grafiek3DTest.ideas.interpret(evalCommand);
