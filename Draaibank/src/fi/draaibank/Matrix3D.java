...
{	
	...
	{
		if (h.containsKey("xx"))
			xx = ((Double) h.get("xx")).doubleValue();
		if (h.containsKey("xy"))
			xy = ((Double) h.get("xy")).doubleValue();
		if (h.containsKey("xz"))
			xz = ((Double) h.get("xz")).doubleValue();
		if (h.containsKey("yx"))
			yx = ((Double) h.get("yx")).doubleValue();
		if (h.containsKey("yy"))
			yy = ((Double) h.get("yy")).doubleValue();
		if (h.containsKey("yz"))
			yz = ((Double) h.get("yz")).doubleValue();
		if (h.containsKey("zx"))
			zx = ((Double) h.get("zx")).doubleValue();
		if (h.containsKey("zy"))
			zy = ((Double) h.get("zy")).doubleValue();
		if (h.containsKey("zz"))
			zz = ((Double) h.get("zz")).doubleValue();
