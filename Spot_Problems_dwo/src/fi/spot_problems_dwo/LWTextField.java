...
class LWTextField extends Component
{   // actual and visible text
    String text = "", textVisible = "";
    ...
    LWTFListener listener;
    // flagg for editing
    boolean editable = true;
    // default constructor
    public LWTextField()
    {   listener = new LWTFListener();
    ...
    {   // background
        ...
        g.drawLine(1, 1, getSize().width - 3, 1);        
        g.drawLine(0, 0, 0, getSize().height - 1);        
        g.drawLine(1, 1, 1, getSize().height - 3);                
        g.setColor(Color.lightGray);
        g.drawLine(1, getSize().height - 3, 
                   getSize().width - 3, getSize().height - 3);        
        g.drawLine(getSize().width - 3, 1, 
                   getSize().width - 3, getSize().height - 3);                
    ...
    // combined listener inner class
    class LWTFListener extends MouseAdapter
