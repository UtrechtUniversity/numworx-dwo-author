...
//System.err.println("lang=" + language + ", locale = " + locale);
    ...
    */
    ...
    /**
    * Haal Images als Resources op. Hack via getResourceAsStream
    * als de ClassLoader getResource niet support (Netscape)
    * en via getCodeBase als getResourceAsStream niet gesupport is.
...
/**
* InputStream van een willekeurige resource. Probeer via getResourceAsStream of via getCodeBase
...
* @exception java.lang.SecurityException in Netscape bij een verkeerde extensie
*/
