...
import java.util.*;
import fi.nabouwenaanzichten.expressies.*;
...
public class Interpreter 
{
	...
	{	s = s.trim();
		String bouwOpdracht = NabouwenAanzichten.rb.getString("bouwOpdracht");
		String sloopOpdracht = NabouwenAanzichten.rb.getString("sloopOpdracht");
