...
abstract class GeogebraEditPanel extends JPanel implements InteractieEditPanel , ActionListener, TabletOwner
{
	 ...
	 * 
	 */
	abstract protected void createGeogebraPanel(String id, Container c);
...
//				uuid = org.apache.commons.codec.digest.DigestUtils.shaHex(data) + ".ggb";
	...
	abstract ResourceManager rm();


	abstract protected Hashtable getGeoGebraEditState();
...
// FIXME Better not an internal frame
	...
	abstract protected void setGeogebraBounds();

	abstract protected void setGeogebraEditState(Hashtable h);
	
	abstract public void zetBreedte(int b);

	abstract public void zetHoogte(int h);
