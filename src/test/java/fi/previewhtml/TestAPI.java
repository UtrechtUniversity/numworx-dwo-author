...
public class TestAPI extends DefaultAPI {
	...
	public String LMSGetValue(String key) {
		...
		if ("cmi.mode".equals(key)) return "normal";
		if ("dme.abo_type".equals(key)) return "premium";
		if ("cmi.completion_status".equals(key)) return "complete";
