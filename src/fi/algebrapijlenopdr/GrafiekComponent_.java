...
public class GrafiekComponent_ extends AlgebraSchuifComponent implements ActionListener, MouseListener, MouseMotionListener
{	
	...
	public GrafiekComponent_(AlgebraSchuifVeld sv,int x, int y, int b, int h)
	{	super(1,sv,x,y,b,h);
