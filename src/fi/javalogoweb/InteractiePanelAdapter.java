...
public class InteractiePanelAdapter extends JPanel implements InteractiePanel, AppletStub, AppletContext
{
	...
	public InteractiePanelAdapter(ScormAppletIF applet)
	{
		...
		if(applet instanceof JApplet)add( "Center", ((JApplet)applet).getContentPane() );
		else 
	...
	{	if(applet!=null)((Component)applet).setBackground(c);
    ...
    public void restart()
	{
    	...
    	{	
    		...
    		{	Class c = Class.forName(className);
    	    	...
    	    	if(applet instanceof JApplet)remove( ((JApplet)applet).getContentPane());
