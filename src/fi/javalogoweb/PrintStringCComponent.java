...
public class PrintStringCComponent extends CommandComponent implements ActionListener
{
	
	public PrintStringCComponent(int x, int y, int b, int h, SchuifVeld sv)
	{	super(x,y,b,h,sv);
		commandString = "print (\"";
		kommaString = null;
		haakjeString = "\") ";
