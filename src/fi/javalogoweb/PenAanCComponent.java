...
public class PenAanCComponent extends CommandComponent implements ActionListener
{
	
	public PenAanCComponent(int x, int y, int b, int h, SchuifVeld sv)
	{	super(x,y,b,h,sv);
		commandString = "penAan ( ";
		kommaString = null;
		haakjeString = ") ";
