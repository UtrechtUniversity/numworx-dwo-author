...
public class BooleanComponent extends Container implements ActionListener, FocusListener, MouseListener
{
	...
	public BooleanComponent(int x, int y, int b, int h)
	{	setBounds(x,y,b,h);
		waarde = null;
		bekend = true;
		leeg = false;
	...
	public void zetWaarde(VergelijkingMeerv e)
	{	waarde = e;
