...
class InvulKeuzePanel2 extends JPanel implements ActionListener //ItemListener
{
	...
	public InvulKeuzePanel2(int x, int y, int b, int h)
	{	setLayout(null);
		...
		//g = new CheckboxGroup();
		g = new ButtonGroup();
		bouwButton = addCheckbox(NabouwenAanzichten.rb.getString("ipRegel1Label"),
					 0, 0, b / 2, 24, true);
		sloopButton = addCheckbox(NabouwenAanzichten.rb.getString("ipRegel2Label"),
				     b / 2, 0, b / 2, 24, false);
		bouwen = true;
	}
	...
	public void setBounds(int x, int y, int b, int h)
	{
		if (bouwButton != null)
		{	
			bouwButton.setBounds(0, 0, b / 2, 24);
			sloopButton.setBounds(b / 2, 0, b / 2, 24);
		}
