...
public class Text_nl extends java.util.ListResourceBundle
{
        ...
        static final Object [] [] contents =
        {
            ...
            {   "extraLabel", "Extra" },
            {	"extraAantalDobbelstenenLabel" , "Aantal dobbelstenen ="},
            {	"extraAantalMuntenLabel" , "Aantal Munten ="},
            {	"extraAantalKeerGooienLabel" , "Aantal keer gooien ="},
            {	"extraGooienLabel" , "Gooi"},
            {	"extraOpnieuwLabel" , "Opnieuw"},
            {	"extraAantalKerenGegooidLabel" , "Aantal keren gegooid"},
            {	"extraTotaalGegooidLabel" , "Totaal aantal keren gegooid"},
            {	"extraTotaalGetalLabel" , "Totaal-getal"},
            {	"extraVerschilGetalLabel" , "Verschil-getal"},
            {	"extraDobbelsteenLabel" , "dobbelsteen"},
            {	"extraHead" , "Kop"},
            {	"extraTail" , "Munt"},
            {	"extraEn" , "en"},
