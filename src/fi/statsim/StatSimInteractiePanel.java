...
public class StatSimInteractiePanel extends JPanel implements InteractiePanel, ActionListener, Runnable {	
	JPanel buttonPanel;
	Thread animatie;
	Button volgende;
	Button start;
	...
	String col[] = {"exp.","Aantal kop","Aantal munt"};
	String col1[] = {"exp.","0 kop","1 kop", "2 kop"};
	...
	public StatSimInteractiePanel() {
		...
		geenKopLabel=new JLabel("Geen kop");
