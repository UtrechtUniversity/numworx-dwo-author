...
/**
 * Interface for DWO Applets. Allow extraction of partial scores.
 * To return a List<Map<String,String>>
 * @author wim
 *
 */
public interface PartialScoreIF {
	...
	/**
	 * Get the list of maps. Keys are LOCATION, SCORE_MAX, SCORE_RAW, DESCRIPTION,
	...
	/**
	 * Get the main page of the applet, without all navigation stuff or scrollbars.
