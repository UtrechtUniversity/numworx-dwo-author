...
public abstract class Scorm {
	 ...
	 * 
	 * @param applet
	 *            The Applet invoking this method.
	 * @return SCORM12APIInterface the appropriate implementation of
	 *         SCORM12APIInterface determined by using Applet.getParameter(
	 *         "API" ).
	 */
