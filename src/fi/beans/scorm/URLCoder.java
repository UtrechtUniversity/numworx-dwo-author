 ...
 * encode - changes all non Character.isJavaIdentifierPart characters into %
 * followed by two hex numbers representing that character<BR>
 * decode - changes all % followed by two hex into the character represented by
 * the hex numbers<BR>
 * 
