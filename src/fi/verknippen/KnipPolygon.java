...
{	
	...
	public KnipPolygon(Vector realPts, DrawingPanel o)
	{	owner = o;
...
//				   " -> " + ((pCnt + qCnt + 1) % aantalPunten));
	...
	{	RealPoint result = null;
		...
		{	RealPoint e1 = realPoints[pCnt];
			RealPoint e2 = realPoints[(pCnt + 1) % aantalPunten];
			Vector gridPoints = gridPointsOnEdge(e1, e2);
	...
	public Vector gridPointsOnEdge(RealPoint e1, RealPoint e2)
