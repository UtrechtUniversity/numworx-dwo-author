...
public class Text_nl extends java.util.ListResourceBundle
{
        ...
        {
            { "maakRechthoekTekst" , "Kun je van deze figuur een rechthoek maken?" },
            { "hoeveelVakjesTekst" , "Uit hoeveel vakjes bestaat deze figuur?" },            
            { "maakNuRechthoekTekst" , "Maak nu van deze figuur een rechthoek" },            
