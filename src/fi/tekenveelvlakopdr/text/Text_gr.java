...
public class Text_gr extends java.util.ListResourceBundle
{
        ...
        {
				{ "lijnKnopLabel" , "Construct line" },
				{ "vlakKnopLabel" , "Construct plane" },
				{ "verbergBasisKnopLabel" , "Hide base polyhedron" },
				{ "toonBasisKnopLabel" , "Show base polyhedron" },
				{ "wisLijnKnopLabel" , "Clear lines" },
                { "wisVlakKnopLabel" , "Clear planes" },
                { "terugKnopLabel" , "Undo" },
				{ "zijdeLabel" , "zoom" },
				{ "kubusLabel" , "cube" },
