...
public class ColumnType implements Serializable {
	 ...
	 * @param type Het AllowedType van deze kolom
	 */
	 ...
	 * @param type Het AllowedType van deze kolom
	 * @param options De door de gebruiker samengestelde enumeratie
	 */
	 ...
	 * @param type Het AllowedType van deze kolom
	 * @param uitleg Uitleg over deze kolom
	 */
	...
	/**
	 * Constructor die een AddColumnDialogModel krijgt, dus de informatie uit de "maak een nieuwe kolom" dialog
	 * @param dialogModel Het model uit de AddColumnDialog
	 */
	public ColumnType(AddColumnDialogModel dialogModel) {
		...
		if(this.type.equals(AllowedTypes.ENUM)) {
			...
			this.enumOptions = dialogModel.getEnumOptions().toArray(this.enumOptions);
		}
