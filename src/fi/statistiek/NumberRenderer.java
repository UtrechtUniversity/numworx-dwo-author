...
public class NumberRenderer extends FormatRenderer
{
	...
	/*
	 * Use the number formatter for the given locale
	 */
	public static NumberRenderer getNumberRenderer(Locale l)
	{
		return new NumberRenderer(NumberFormat.getInstance(l));
	}
