 ...
 *
 */
public class FrequencyTableController implements StatistiekView, ActionListener, FocusListener{
	 ...
	 * @param viewName the initial name of the view
	 */
	public FrequencyTableController(StatTableModel tableModel, String viewName, int startVar) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(action.equals("columnIndexBox")) {
			...
			this.model.setShowCumulative(this.view.isShowCumulativeBoxSelected());
		}
	...
	public void setState(Object state) {
		...
		if(h.containsKey("binBoundaries")) {
			this.model.setBinBoundaries((ArrayList<Double>)h.get("binBoundaries"));
		}
