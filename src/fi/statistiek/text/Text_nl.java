	...
	static final Object[][] contents =
		{
				...
				{ "valueIs", "waarde = " },
				{ "sortAscendingItem", "Sorteer oplopend" },
				{ "sortDescendingItem", "Sorteer aflopend" },
				...
				{ "importCSVformatWarning",
					"Het CSV-bestand bevat kolommen met dezelfde naam. Dit is niet toegestaan. Gebruik unieke kolomnamen." },
				...
				{ "amountLabel", "Aantal" },
				{ "splitsingleviewCheckBox", "split in ��n scherm" },
				{ "addacolumn", "Voeg een kolom toe" },
				{ "editacolumn", "Bewerk kolom" },
				{ "columninfo", "Kolominfo" },
				{ "columnname", "Kolom naam:" },
				{ "choosetype", "Kies type:" },
				{ "computeVariable", "Bereken variabele" },
				{ "cancelComputeVariable", "Annuleer bereken variabele" },
				{ "computeVariableLabel", "Voer formule in m.b.v. kolomnamen:" },
