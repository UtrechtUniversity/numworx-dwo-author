...
public class AddColumnDialogView extends JDialog implements Observer {
	...
	private void initialize() {
		...
		this.addEnumElementLabel = new JLabel(Statistiek.rb.getString("addenumeration"));
		...
		*/
		this.enumElementsList = new OrderableJList(new OrderableJListModel(this.model.getEnumOptions()));
		this.enumScrollPane = new JScrollPane(this.enumElementsList);
		this.removeSelectedElement = new JButton(Statistiek.rb.getString("removeselectedelement"));
		...
		this.createEnumPanel.add(this.removeSelectedElement, BorderLayout.SOUTH);
	 ...
	 * @param al the subscribing ActionListener
	 */
	 ...
	 * @param fl the subscribing FocusListener
	 */
	...
	public void update(Observable o, Object arg) {		
		...
		//set the visibility
		this.createEnumPanel.setVisible(this.model.getType().equals(AllowedTypes.ENUM));
		this.enumElementsList.setVisible(this.model.getType().equals(AllowedTypes.ENUM));
