package fi.geomalgebra.expressies;
...
import fi.geomalgebra.GeomAlgebra;
...
{	
	...
	{	dfs = new DecimalFormatSymbols();
		if(GeomAlgebra.language.toString().equals("nl")) dfs.setDecimalSeparator(',');
		else dfs.setDecimalSeparator('.');
		if(GeomAlgebra.language.toString().equals("nl")) dfs.setGroupingSeparator(' ');
