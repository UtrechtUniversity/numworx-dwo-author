...
public class BlokjesMaalPanel extends ScPanel implements ActionListener {
	...
	int score;
	int aantalPunten;
	String[] getalWoorden = { Heks.rb.getString("int0Label"), Heks.rb.getString("int1Label"), Heks.rb.getString("int2Label"), Heks.rb.getString("int3Label"),
			Heks.rb.getString("int4Label"), Heks.rb.getString("int5Label"), Heks.rb.getString("int6Label"), Heks.rb.getString("int7Label"),
	...
	public BlokjesMaalPanel(int x, int y, int b, int h, Applet applet) {
		...
		goedFoutLabel = new ScLabel(110, 430, 120, 40, "");
		add(goedFoutLabel);
		...
		tabel = new TabelComponent(2, 5, 0, 0, 550, 250, false);
		...
		scoreLabel = new ScLabel(30, 220, 150, 40, "");
	...
	public void zetSom(Som som) {
		...
		if (teken)
			beginKeerLabel.setText("" + getalWoorden[som.geefTerm1()] + Heks.rb.getString("keerErbijLabel"));
		else
			beginKeerLabel.setText("" + getalWoorden[-som.geefTerm1()] + Heks.rb.getString("keerEruitLabel"));
		teken = som.geefTerm2() > 0;
		if (teken)
			aantalBlLabel.setText("" + getalWoorden[som.geefTerm2()] + Heks.rb.getString("warmeBlokjesLabel"));
		else
			aantalBlLabel.setText("" + getalWoorden[-som.geefTerm2()] + Heks.rb.getString("koudeBlokjesLabel"));
