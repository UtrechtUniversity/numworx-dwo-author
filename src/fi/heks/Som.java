...
{	
	...
	{	term1 = (int)(-10 + 20*Math.random());
		...
		{	operator = "+";
			...
			if(term2==0)term2 = (int)(-10 + 9*Math.random());
			if(term1>-1 && term2>-1 && uitkomst>-1) 
			{	if(term1!=0)term1 = -term1;
				else term2 = -term2;
			}
			uitkomst = term1 + term2;
		}
		...
		{	operator = "x";
			uitkomst = term1 * term2;
			if(term2==0 || term2==1)term2 = (int)(-10 + 9*Math.random());
			if(term1==0 || term1==1)term1 = (int)(-10 + 9*Math.random());
			if(term1>-1 && term2>-1 ) 
			{	if(term1!=0)term1 = -term1;
				else term2 = -term2;
			}
