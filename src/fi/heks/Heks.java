...
{	public double schaal;
	...
	{	String variantString = super.getParameter("variant");
		...
		else if(bladNummer==3)tp = new BlokjesErbijPanel(5,5,790,565,this);
		else if(bladNummer==4)tp = new OefentoetsPanel(5,5,790,565,this,Som.PLUS);
		else if(bladNummer==5)tp = new TweeManierenPanel(5,5,790,565,this);
		else if(bladNummer==6)tp = new BlokjesEruitPanel(5,5,790,565,this);
		else if(bladNummer==7)tp = new OefentoetsPanel(5,5,790,565,this,Som.MIN);
		else if(bladNummer==8)tp = new OefentoetsPanel(5,5,790,565,this,Som.PLUSMIN);
		else if(bladNummer==9)tp = new OefentoetsPanelExtra(5,5,790,565,this,Som.PLUSMIN,false);
		else if(bladNummer==10)tp = new TafereelPanelEmmer(5,5,790,565,this);
		else if(bladNummer==11)tp = new OefentoetsPanelExtra(5,5,790,565,this,Som.MAAL,true);
		else if(bladNummer==12)tp = new OefentoetsPanelExtra(5,5,790,565,this,Som.MAAL,false);
		else if(bladNummer==13)tp = new BlokjesErbijPanelExtra(5,5,790,565,this);
		...
		else if(bladNummer==25)tp = new OefentoetsPanel_WN(5,5,990,665,this,Som.PLUS);
		else if(bladNummer==26)tp = new BlokjesErbijPanel_WN(5,5,560,400,this);
		else if(bladNummer==27)tp = new OefentoetsPanel_WN(5,5,990,665,this,Som.PLUSMIN);
		else if(bladNummer==28)tp = new OefentoetsPanelExtra_WN(5,5,990,665,this,Som.PLUSMIN,false);
		else if(bladNummer==29)tp = new OefentoetsPanelExtra_WN(5,5,990,665,this,Som.MAAL,true);
	...
	{	Hashtable tpState = null;
	    ...
	    Hashtable h = new Hashtable();
	    if(tpState!=null)h.put("tpState", tpState);
