...
{	
	...
	{	super(x,y,b,h);
		...
		if(soort == Som.PLUSMIN)titelLabel = new ScLabel(20,20,200,40,"Oefentoets 4");
		else if(soort == Som.MAAL && rechtsInv)titelLabel = new ScLabel(20,20,200,40,"Oefentoets 5");
