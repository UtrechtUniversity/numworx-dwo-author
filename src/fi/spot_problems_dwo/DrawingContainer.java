...
{   // attributes
    ...
    // default spot color 
    Color gColor = DrawingContainer.spotColors[0];
...
{   // attributes
    ...
    // use a separate method initialize()
    ...
    {   // NOTE: get the Size() of the DrawingContainer instance as the Size()
        // of its parent, the BufferPanel instance (possible since it has been
        // added, and because of the BorderLayout of the Bufferpanel instance),
