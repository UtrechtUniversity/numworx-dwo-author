...
{	
	...
	protected FormuleButton wortelKnop, machtKnop, kwadraatKnop, breukKnop, haakjesKnop, 
							ndewortelKnop, ndelogKnop, integraalKnop, prvKnop, absKnop;
	...
	{	setLayout(null);
		...
		if("MW".equals(Grafiek3DTest.deployVariant))// || "GR".equals(WiskOpdr.deployVariant)
		...
		if("GR".equals(Grafiek3DTest.deployVariant))// || "GR".equals(WiskOpdr.deployVariant)
        {   setScrollHorizontal(false);
            scrollPane.setBorder(BorderFactory.createLineBorder(new Color(210,210,210),2));
        }
		...
		if("MW".equals(Grafiek3DTest.deployVariant))
		{	
			headerPanel.add(ndewortelKnop);
	...
	{	
		...
		if(("MW".equals(Grafiek3DTest.deployVariant) || "GR".equals(Grafiek3DTest.deployVariant))&& grafiekOfEdit)
		{	
			headerPanel.add(ndewortelKnop);
// snoei			
			...
			if("GR".equals(Grafiek3DTest.deployVariant))nieuweRegelKnop.setBounds(172,0,16,23);
			verwijderRegelKnop.setBounds(180,0,21,23);
			if("GR".equals(Grafiek3DTest.deployVariant))verwijderRegelKnop.setBounds(186,0,16,23);
	...
	{	if(headerAan)
		...
		setNewScrollSize();
		if("MW".equals(Grafiek3DTest.deployVariant)&&!grafiekOfEdit)
		{	
// snoei			
		...
		if("GR".equals(Grafiek3DTest.deployVariant)&&!grafiekOfEdit)
        {   nieuweRegelKnop.setLocation(getSize().width-44,0);
