...
{	
	...
	{	super.zetMaat();
		...
		if(Grafiek3DTest.language.toString().equals("en"))g.drawString("log", 3 ,ashoogte + asc/2 + asc/12);
		...
		int locy = k2h/2;
		if(Grafiek3DTest.language.toString().equals("en"))locy = 0;
    ...
    {   super.zetMaat();
        ...
        if(Grafiek3DTest.language.toString().equals("en"))ashoogte = kind1.ashoogte;
        
        kind1.setLocation(k2w + fStr + 3*asc/4, k2h/2);
        kind2.setLocation(asc/3, ashoogte-(k2h/2 + asc/2));
        
        if(Grafiek3DTest.language.toString().equals("en"))
        {
