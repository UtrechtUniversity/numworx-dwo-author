...
{	
	...
	{	formuleVak = fv;
		...
		Font font2 = new Font(fv.getFont().getName(),fv.getFont().getStyle(),(int)(2.0*size/3));
	...
	{	super.setFont(f);
		...
		if(!getFont().getName().equals("TimesRoman"))size += 2;
		Font font2 = new Font(getFont().getName(),getFont().getStyle(),(int)(2.0*size/3));
