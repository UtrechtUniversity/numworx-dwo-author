...
{	
	...
	{	code = s;
		...
		{	
			...
			if("MW".equals(Grafiek3DTest.deployVariant)&&soort==NAVIGATIEKNOP) ui = NWButtonUI.getInstance("mw_formbutton_skin_orange.png");
			else if("GR".equals(Grafiek3DTest.deployVariant)&&soort==NAVIGATIEKNOP) ui = NWButtonUI.getInstance("gr_formbutton_skin_graf.gif");
			if(soort==TABLETKNOP) ui = NWButtonUI.getInstance("mw_formbutton_skin_tablet.png");
			if("GR".equals(Grafiek3DTest.deployVariant)&&soort==TABLETKNOP) ui = NWButtonUI.getInstance("mw_formbutton_skin_gray.png");
			if(soort==MEERKNOP) ui = NWButtonUI.getInstance("mw_formbutton_skin_white.png");
			setUI(ui);
			NWButtonUI.setIcon(code, this);
			if(code.equals("\u2227"))setToolTipText(" "+Grafiek3DTest.rb.getString("enLabel")+" ");
			if(code.equals("\u2228"))setToolTipText(" "+Grafiek3DTest.rb.getString("ofLabel")+" ");
			if(code.equals("\u2205"))setToolTipText(" "+Grafiek3DTest.rb.getString("geenOplossingen")+" ");
		}
	...
	public void paintCode(Graphics g)
	{
		...
		else if(code.equals(Grafiek3DTest.rb.getString("grafiekComponentLabel")))
		{	//g.drawString("A",7,15);
		...
		else if(code.equals(Grafiek3DTest.rb.getString("interactieVakLabel")))
		...
		else if(code.equals(Grafiek3DTest.rb.getString("antwoordVakLabel")))
		{	//g.drawString("V",7,15);
			g.setColor(Color.white);
		...
		else if(code.equals(Grafiek3DTest.rb.getString("tekstVakLabel")))
		{	g.setColor(Color.gray);
	        g.drawRect(3,5,13,10);
		}
		...
		{	g.setFont(new Font("TimesRoman", Font.ITALIC , 16));
			if(Grafiek3DTest.mac) g.setFont(new Font("SansSerif", Font.ITALIC , 13));
			g.drawString("\u03C0",5,15);
        ...
        {   g.setFont(new Font("SansSerif", Font.PLAIN, 10));
            g.drawString(Grafiek3DTest.rb.getString("meerLabel"),5,3*getSize().height/6);
            g.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		{	g.setFont(new Font("SansSerif", Font.PLAIN, 10));
			...
			if(Grafiek3DTest.mobileVersion)
			{	g.setFont(new Font("SansSerif", Font.PLAIN, 8));
				g.drawString(code,1,10);
			}
			else if(code.equals("abc"))g.drawString(Grafiek3DTest.rb.getString("abc"),1,15);
