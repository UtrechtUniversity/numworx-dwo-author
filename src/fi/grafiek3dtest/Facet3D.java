...
// changing via rebuild!    
    ...
    public Color planeOutlineColor = brownRed;    
    public Color pointColor = darkGreen;
    ...
    public Color tickColor = darkGreen;
    public Color hiddenTickColor = mediumGreen;
