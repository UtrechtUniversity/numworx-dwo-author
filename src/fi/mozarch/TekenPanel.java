...
*/			
		...
		{	
			...
			if (!beginFig)
			{	maakFractiel(beginFractielType, 1, dummyX, startY, new Color(230, 230, 230));
			}
			else 
			{	maakFractiel(beginFractielType, 1, startX, startY, new Color(230, 230, 230));
			}
