...
public class AntwoordFormuleVakChecker
{
	...
	public AntwoordFormuleVakChecker( AntwoordFormuleVak antwoordFormuleVak, Hashtable afvCheckerModel, String[] randomVars, Hashtable randomValues )
	{	
		...
		if(afvCheckerModel.containsKey("answerModels")) answerModels = (Hashtable[])afvCheckerModel.get("answerModels");
		...
		if(tips){
			if(afvCheckerModel.containsKey("ideasInstellingen")) ideasInstellingen = (Hashtable)afvCheckerModel.get("ideasInstellingen");
	    }
	...
	public Hashtable checkAnswer(String answer, String answerPrevious)
	{	return checkAnswer(answer, answerPrevious, null,null);
	}
	
	public Hashtable checkAnswer(String answer)
	{	return checkAnswer(answer,null,null,null);
	}
	
	public Hashtable checkAnswer(String answer, String answerPrevious, Expressie substitutie, Vergelijking[] gebruikersSubstituties)
	{	this.isGelijkwaardig = false;
		...
		Hashtable checkResults = new Hashtable();
	...
	{	
		...
		{	if(antwoordStrings[i]!=null)
			{	String[] antwoordDelen = StringUtils.split(antwoordStrings[i],"±");//"ï¿½");
