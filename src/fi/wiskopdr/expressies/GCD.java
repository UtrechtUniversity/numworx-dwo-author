...
{	double waarde = Double.NaN;
	...
	{	
		...
		double waarde;
		if(Double.isNaN(kind1.geefWaarde()) || Double.isNaN(kind2.geefWaarde())) waarde = Double.NaN;
	...
	{	
		...
		double waarde;
		if(Double.isNaN(kind1.geefWaarde(subst)) || Double.isNaN(kind2.geefWaarde(subst))) waarde = Double.NaN;
		else waarde = getGCD(m,n);			
		return waarde;
	}
	...
	{	
		...
		double waarde;
		if(Double.isNaN(kind1.geefWaarde(subst,vars)) || Double.isNaN(kind2.geefWaarde(subst,vars))) waarde = Double.NaN;
		else waarde = getGCD(m,n);			
		return waarde;
	}
	...
	{	
		...
		double waarde;
		if(Double.isNaN(kind1.geefWaarde(substD,vars)) || Double.isNaN(kind2.geefWaarde(substD,vars))) waarde = Double.NaN;
		else waarde = getGCD(m,n);		
	...
	{	
		...
		double waarde;
		if(Double.isNaN(kind1.geefWaarde(substD)) || Double.isNaN(kind2.geefWaarde(substD))) waarde = Double.NaN;
		else waarde = getGCD(m,n);			
		return new Complex(waarde);
	}
	...
	{	return new GCD(kind1.vervangDifferentialen(var), kind2.vervangDifferentialen(var));
	}
	
	public Expressie vervangDiffs(Expressie subst, String var)
	{
		return new GCD(kind1.vervangDiffs(subst, var), kind2.vervangDiffs(subst, var));
	}
