...
{	
	...
	private static double defaultPrecision = 0.000000001;
	...
	{	if(d<0.000000001)absPrecision = d; //setDefaultAbsPrecision();
...
//		System.out.println("Algebra.zijnGelijk(): e1 = " + e1 + ", e2 = " + e2 + ", vorm = " + vorm);
		...
		else if(e1 instanceof Deling && e2 instanceof Deling)
...
//				return false;
	...
	public static boolean isMinExpressie(Expressie e)
	{	return(e instanceof Aftrekking && e.kind1.geefWaarde()==0);
	}
	...
	//System.out.println("herleidMild: "+e.toString());
		...
		/*boolean rn = e.kind1!=null && e.kind1.toString().indexOf("rns$h")>-1
				...
				|| e.kind1!=null && e.kind1.toString().indexOf("rnd$h")>-1
				|| e.kind2!=null && e.kind2.toString().indexOf("rnd$h")>-1
				|| e.kind1!=null && e.kind1.toString().indexOf("rnq$h")>-1
				|| e.kind2!=null && e.kind2.toString().indexOf("rnq$h")>-1;
		*/		
		if(e.isWaarde())
