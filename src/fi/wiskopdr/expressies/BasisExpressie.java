...
{	String 	basisString;
	...
	public void setScientificNotation(boolean b, int macht, int signf)
	{
		...
		*/
		...
		//System.out.println("waardeDigits: "+waardeDigits);
		//System.out.println("basisStringVoor: "+basisString);
		waardeDigits = SigRound.roundToSignificantFigures(waardeDigits, signf);
		basisString = df.format(waardeDigits);
		//System.out.println("basisStringNa: "+basisString);
		...
		int aantalSign = (int)(new AantalSign(this)).geefWaarde();
		//System.out.println("aantalSign: "+aantalSign);
		int tekortSign = signf-aantalSign;
		
		for(int i=0 ; i<tekortSign ; i++)
		{	if(i==0 && basisString.indexOf(',')==-1 && basisString.indexOf('.')==-1)basisString = basisString + ".";
			basisString = basisString + "0";
		}
		basisString = basisString+"E"+macht;
	}
