...
{	double waarde = Double.NaN;
	...
	{
		return new NormalCDF(kind1.vervangDiffs(subst, var), kind2.vervangDiffs(subst, var), kind3.vervangDiffs(subst, var), kind4.vervangDiffs(subst, var));
	}
	...
	{	String s1 = kind1.geefVarNaam();
		...
		if("".equals(s1) || "".equals(s2) || "".equals(s3) || "".equals(s4))return "";
		else if(s1!=null && s2!=null && !s1.equals(s2))return "";
		else if(s1!=null && s3!=null && !s1.equals(s3))return "";
		else if(s1!=null && s4!=null && !s1.equals(s4))return "";
		else if(s2!=null && s3!=null && !s2.equals(s3))return "";
		else if(s2!=null && s4!=null && !s2.equals(s4))return "";
		else if(s3!=null && s4!=null && !s3.equals(s4))return "";
		
		else if(s1!=null && s2!=null && s1.equals(s2))return s1;
		else if(s1!=null && s3!=null && s1.equals(s3))return s1;
		else if(s1!=null && s4!=null && s1.equals(s4))return s1;
		else if(s2!=null && s3!=null && s2.equals(s3))return s2;
		else if(s2!=null && s4!=null && s2.equals(s4))return s2;
		else if(s3!=null && s4!=null && s3.equals(s4))return s3;
		
		else if(s1!=null)return s1;
		else if(s2!=null)return s2;
		else if(s3!=null)return s3;
		else if(s4!=null)return s4;
