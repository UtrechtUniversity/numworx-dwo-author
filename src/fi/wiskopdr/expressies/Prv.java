...
{	double waarde = Double.NaN;
	...
	{	kind1 = e1;
        ...
        if(kind4==null || varnamen==null || varnamen.length==0 || varnamen.length>1) kind4 = new BasisExpressie("x");
		else kind4 = new BasisExpressie(varnamen[0]);
		isVeelterm = false;
		isProdukt = false;
		isBasis = false;
	}
	...
	{	String[] vars = {kind4.geefVarNaam()};
        double[] subst2 = {kind2.geefWaarde()};
        double[] subst3 = {kind3.geefWaarde()};
	...
	{	if(var.equals(kind4.geefVarNaam()))	return this;			
