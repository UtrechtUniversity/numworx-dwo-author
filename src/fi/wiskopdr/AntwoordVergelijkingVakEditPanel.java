...
//        add(solveButton,0);
    ...
    public void makeNewPanel() {
		...
		JLabel titleLabel = new JLabel(WiskOpdr.rb.getString("titleVergelijkingAntwVakLabel"));
		if(soort==3)
			titleLabel = new JLabel(WiskOpdr.rb.getString("titleSimpelVergelijkingAntwVakLabel"));
