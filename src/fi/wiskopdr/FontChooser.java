...
public class FontChooser extends JDialog {
  ...
  // TODO ook een versie voor bovenop een dialog
  ...
  public static Font makeFont(Frame owner, Font oldFont)
  {
	  ...
	  {
		  String name = dlg.fontNameInputList.getSelected();
		    int size = dlg.fontSizeInputList.getSelectedInt();
		    
		    int style = Font.PLAIN;
		    if (dlg.boldCheckBox.isSelected())
		      style |= Font.BOLD;
		    if (dlg.italicCheckBox.isSelected())
		      style |= Font.ITALIC;
