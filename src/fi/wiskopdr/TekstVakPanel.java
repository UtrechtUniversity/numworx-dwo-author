...
public class TekstVakPanel extends RoundedPanel implements TabletOwner, InteractiePanel, ActionListener, MouseListener, MouseMotionListener, CBookAware
{
	...
	public static void addTemplatePage(String key, String content) {
		...
		if(templatePagesKeys==null)
			templatePagesKeys = new ArrayList<String>();
		templatePages.put(key,  content);
		templatePagesKeys.remove(key);
		templatePagesKeys.add(key);
	}
	
	public static void addTemplateComponent(String key, String content) {
		if(templateComponents==null)
			templateComponents = new Hashtable<String,String>();
		if(templateComponentsKeys==null)
			templateComponentsKeys = new ArrayList<String>();
		
		templateComponents.put(key,  content);
		templateComponentsKeys.remove(key);
		templateComponentsKeys.add(key);
	}
	
	
	
	//public static String template1 = "$@";
	//public static String component1 = "$@$@";
...
// Wim: always initialize subcomponents, with 'no state';
	...
	public void paintComponent(Graphics gr)
	{
		...
		if (editable && (selectable || sleepbaar || sleepdoel))
		{	g.setColor(Color.gray);
			g.setFont(new Font("SansSerif",Font.PLAIN,10));
			if(sleepbaar || selectable)
				g.drawString(""+ipId, tekstVakken[0][0].getWidth()-10, 10);
			if(sleepdoel)
				g.drawString(""+ipId, tekstVakken[0][0].getWidth()-13, 10);
		}
		if (editable && callOut)
		{
			Point[] stippen = getCallOutDots();
