...
//			lockToetsCB.setBounds(getWidth() - 220, getHeight() - 23, 120, 20);
	...
	public void setJSONState(Hashtable onsState, Hashtable reviewState) {
		if(reviewState==null || reviewState.isEmpty())
			...
			Hashtable mergedTable = mergeReviewStateHashtable(onsState, reviewState);
			if(mergedTable!=null)
				setState(mergedTable);
			else
				setState(onsState);
		}
	}
...
//			}
	...
	public Hashtable mergeReviewStateHashtable (Hashtable state, Hashtable reviewState) {
		if(reviewState==null || reviewState.isEmpty())
			return null;
		Hashtable[][] opdrContStates;
	...
	private void mergeReviewStateRecursief (Hashtable state, Hashtable reviewState) {
		if(reviewState.containsKey("reviewInteractieData")) {
			Hashtable reviewInteractieData = toHashtable(reviewState.get("reviewInteractieData"));
