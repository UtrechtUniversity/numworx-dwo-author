...
public class ProgrammaImporter 
{
	...
	private String[] deeltaaknamenTrans =	
		{ JavaLogoWeb3d.rb.getString("deeltaak")+"1", JavaLogoWeb3d.rb.getString("deeltaak")+"2", JavaLogoWeb3d.rb.getString("deeltaak")+"3",
			JavaLogoWeb3d.rb.getString("deeltaak")+"4", JavaLogoWeb3d.rb.getString("deeltaak")+"5" };		
	...
	private String strIf1Trans = JavaLogoWeb3d.rb.getString("keuze") + " " + JavaLogoWeb3d.rb.getString("alsLabel");
	private String strIf2Trans = JavaLogoWeb3d.rb.getString("danLabel");
	private String strFor1Trans = JavaLogoWeb3d.rb.getString("Herhaal");
	private String strFor2Trans = JavaLogoWeb3d.rb.getString("keer2");
	private String strWhile1Trans = JavaLogoWeb3d.rb.getString("Zolang");
	private String strWhile2Trans = JavaLogoWeb3d.rb.getString("herhaal2");
	...
	void importProgramma(String s)
	{
		...
		String[] codeParts2 = StringUtils.split(programmaTekst, JavaLogoWeb3d.rb.getString("deeltaak1"));
	...
	private void readBlock(ArrayList<String> lines, CompositeCommandComponent ccont)
	{
		...
		while ( !lines.isEmpty() )
		{
			...
			line = lines.remove(0);
			if (line.startsWith("Herhaal") || line.startsWith(JavaLogoWeb3d.rb.getString("Herhaal")))
			{
				//System.out.println("+++  Start For-loop");
				ccomp = readForLoopCommand(ccont, line, lines);
			}
			if (line.startsWith("Zolang") || line.startsWith(JavaLogoWeb3d.rb.getString("Zolang")))
			{
				//System.out.println("+++  Start While-loop");
				ccomp = readWhileLoopCommand(ccont, line, lines);
			}
			else if (line.startsWith("Keuze:") || line.startsWith(JavaLogoWeb3d.rb.getString("keuze")))
			{
	...
	private CommandComponent readKeuzeCommand(CompositeCommandComponent ccont, String headerline, ArrayList<String> lines)
	{
		...
		if  ( !lines.isEmpty() )
		{
			...
			if (s2.equals("Anders") || s2.equals(JavaLogoWeb3d.rb.getString("andersLabel")))
			{
	...
	private CommandComponent readSimpleCommand(String codeline)
	{
		...
		// Fix PBgv, 2015-08-16: quick fix, '(' added to commandname so you can import vars like 'stapgrootte'
		// Fix PBgv, 2015-08-16: command 'println' was mispelled as 'printl'!!
		if (codeline.startsWith("vooruit(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("vooruit") + "("))
		{	cc = new VooruitCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("rechts(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("rechts") + "("))
		{	cc = new RechtsCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("links(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("links") + "("))
		{	cc = new LinksCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("stap(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("stap") + "("))
		{	cc = new StapCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("stapx(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("stapx") + "("))
		{	cc = new StapXCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("stapy(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("stapy") + "("))
		{	cc = new StapYCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("zdraai(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("zdraai") + "("))
		{	cc = new ZDraaiCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("stapz(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("stapz") + "("))
		{	cc = new StapZCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("stap3d(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("stap3d") + "("))
		{	cc = new Stap3DCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("xdraai(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("xdraai") + "("))
		{	cc = new XDraaiCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("ydraai(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("ydraai") + "("))
		{	cc = new YDraaiCComponent(-100,-100,25,25, veld);
		}
		
		else if (codeline.startsWith("penAan(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("penAan") + "("))
		{	cc = new PenAanCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("penUit(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("penUit") + "("))
		{	cc = new PenUitCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("vulAan(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("vulAan") + "("))
		{	cc = new VulAanCComponent(-100,-100,25,25, veld);
		}
		else if (codeline.startsWith("vulUit(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("vulUit") + "("))
		{	cc = new VulUitCComponent(-100,-100,25,25, veld);
		}
// even niet		
		//else if (codeline.startsWith("vulBlad(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("vulBlad") + "("))
		//{	cc = new VulBladCComponent(-100,-100,25,25, veld);
		//} 
		//else if (codeline.startsWith("print(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("print") + "("))
		//{	cc = new PrintCComponent(-100,-100,25,25, veld);
		//}
		//else if (codeline.startsWith("println(") || codeline.startsWith(JavaLogoWeb3d.rb.getString("println") + "("))
