...
class ScormEditMainFrame extends MainFrame implements ActionListener
{	ScormEditComponentIF scormEditComponent;
	...
	{	Hashtable launchData = scormEditComponent.getLaunchData();
		...
		out.println("	<TITLE>Algebrapijlen Opdrachten</TITLE>");
		...
		out.println("<APPLET");
		out.println("	id		= \"algebrapijlenopdr\"");
		out.println("	name	= \"algebrapijlenopdr\"");
		out.println("	codebase = \"http://www.fi.uu.nl/javaclasses/\"");
		out.println("	code	= \"fi.algebrapijlenopdr.AlgebraPijlenOpdr.class\"");
		out.println("	archive	= \"jars/algebrapijlenopdr.jar\"");
	...
	{	Hashtable launchData = scormEditComponent.getLaunchData();
		...
		out.println("	name	= \"algebrapijlenopdr\"");
		out.println("	code	= \"fi.algebrapijlenopdr.AlgebraPijlenOpdr.class\"");
		out.println("	archive	= \"algebrapijlenopdr.jar\"");
		out.println("	width	= \"770\"");
	...
	{	String jarname = System.getProperty( "java.class.path" );
	    ...
	    try 
	    {
	    	...
	    	out.putNextEntry(new ZipEntry("sco\\AlgebraPijlenOpdr.htm"));
	    	int len;
	...
	{	File dataFile = null;
		...
		{	ZipFile zipFile = new ZipFile(zipName);
			ZipEntry entry = zipFile.getEntry("sco\\AlgebraPijlenOpdr.htm");
