...
public class AlgebraExprInteractieEditPanel extends JPanel implements InteractieEditPanel, ActionListener
{
	/**
	 * 
	 */
	...
	JCheckBox brugklasBox;// , terugHeenBox, tabelBox,
	JCheckBox grafiekBox, scrollBox, zoomBox;
	...
	public AlgebraExprInteractieEditPanel()
	{
		setLayout(null);
		apoip = new AlgebraExprInteractiePanel();
		add(apoip);
		...
		toolkitButton = new JRadioButton(AlgebraExpressies.rb.getString("toolkitTekst"), true);
		...
		invulButton = new JRadioButton(AlgebraExpressies.rb.getString("invulTekst"));
		...
		demoButton = new JRadioButton(AlgebraExpressies.rb.getString("demoTekst"));
		...
		brugklasBox = new JCheckBox(AlgebraExpressies.rb.getString("brugklasTekst"));
		...
		grafiekBox = new JCheckBox(AlgebraExpressies.rb.getString("grafiekTekst"));
		...
		scrollBox = new JCheckBox(AlgebraExpressies.rb.getString("scrollTekst"));
		...
		zoomBox = new JCheckBox(AlgebraExpressies.rb.getString("zoomTekst"));
		...
		kijkNaBox = new JCheckBox(AlgebraExpressies.rb.getString("kijkNaActief"));
		...
		checkExternalBox = new JCheckBox(AlgebraExpressies.rb.getString("checkExternal"));
		...
		toonDocExpButton = new JButton(AlgebraExpressies.rb.getString("toonDocExpTekst"));
		...
		maxScoreLabel = new JLabel(AlgebraExpressies.rb.getString("maxScoreTekst"));
	...
	public void plaatsComponenten()
	{
		if (componentsCreated)
		{
			...
			// terugHeenBox.setLocation(apoip.getSize().width + offset,
			// terugHeenBox.getLocation().y);
			// tabelBox.setLocation(apoip.getSize().width + offset,
			// tabelBox.getLocation().y);
			...
			// toonDocExpBox.setLocation(apoip.getSize().width + offset,
			// toonDocExpBox.getLocation().y);
	...
	public void setEditState(Hashtable b)
	{
		...
		/*
		 * boolean terugHeen = true; if (b.containsKey("terugHeen")) terugHeen =
		 * ((Boolean) b.get("terugHeen")).booleanValue();
		 * terugHeenBox.setSelected(terugHeen);
		 */
		/*
		 * boolean tabelOptie = true; if (b.containsKey("tabelOptie"))
		...
		if (!kijkNaActief) // dan ook niet extern controleren enabled en geen
							// nakijkknop zichtbaar
		{
		...
		/*
		 * if (beginExpBox.isSelected()) { beginExpressiePanel.setVisible(true);
		 * apoip.disableElements(true);
		 * 
		 * }
		 */
	...
	public Hashtable getEditState()
	{
		 ...
		 * String beginExpressieString = ""; if
		 * (beginExpressiePanel.getCorrectExpressieStrings().size() > 0)
		 * beginExpressieString = (String)
		 * beginExpressiePanel.getCorrectExpressieStrings().elementAt(0);
