...
public class TekenVijfvlakPyrProg extends TekenApplet3D implements ActionListener,ItemListener
{	
	...
	{	maakMuisActieMogelijk();
		...
		int[] rib = {0,1,1,2,2,3,3,0,1,4,2,4,3,4,0,4};
