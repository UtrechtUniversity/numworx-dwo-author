...
public class AntiPrismaProg extends TekenApplet3D implements  NumberListener
{	
	Matrix3D matrot;
	Polygon[] p;
	...
	{	maakMuisActieMogelijk();
		...
		aantalInv = new NumberArrow(3,40,3,1,0,"aantal zijden","");
		aantalInv.addNumberListener(this);
		aantalInv.setValue(3);
