...
public class TekenAntiPrismaProg extends TekenApplet3D implements  NumberListener
{	
	...
	{	maakMuisActieMogelijk();
		...
		aantalInv = new NumberArrow(3,40,6,1,0,"aantal zijden","");
		aantalInv.addNumberListener(this);
		aantalInv.setValue(6);
	...
	{	if(name.equals("hoogte"))
		{	hoogte = val;
			v = new AntiPrisma(1.0,aantal,hoogte/100);
		}
		else
		{	aantal = (int)val;
			v = new AntiPrisma(1.0,aantal,hoogte/100);
