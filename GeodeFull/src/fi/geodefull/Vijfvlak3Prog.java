...
public class Vijfvlak3Prog extends TekenApplet3D
{	
	Matrix3D matrot;
	...
	{	maakMuisActieMogelijk();
		...
		Hoekpunt[] hp1 = {tv.hoekpunten[1],tv.hoekpunten[3],tv.hoekpunten[7]};
		tv.vlakken[0]=new Vlak(3,hp1);
		Hoekpunt[] hp2 = {tv.hoekpunten[7],tv.hoekpunten[3],tv.hoekpunten[14]};
		tv.vlakken[1]=new Vlak(3,hp2);
		Hoekpunt[] hp3 = {tv.hoekpunten[14],tv.hoekpunten[3],tv.hoekpunten[0]};
		tv.vlakken[2]=new Vlak(3,hp3);
		Hoekpunt[] hp4 = {tv.hoekpunten[1],tv.hoekpunten[7],tv.hoekpunten[14],tv.hoekpunten[0]};
		tv.vlakken[3]=new Vlak(4,hp4);
		Hoekpunt[] hp5 = {tv.hoekpunten[0],tv.hoekpunten[3],tv.hoekpunten[1]};
