...
class Slider extends JPanel
 {	double huidigePos;						// position, value from 0 to 1
	...
	{	setPreferredSize(new Dimension(100,20));					// for now fixed size (not needed for functionality)
		dd = getSize();
		huidigePos = initp;
	}
 ...
 */
	...
	{	setBackground(Color.white);
		...
		lmin.setBackground(Color.white);
		...
		lmax.setBackground(Color.white);
